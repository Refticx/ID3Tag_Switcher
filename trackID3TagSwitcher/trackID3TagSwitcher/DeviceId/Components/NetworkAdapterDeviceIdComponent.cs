...
namespace DeviceId.Components
{
    ...
    public class NetworkAdapterDeviceIdComponent : IDeviceIdComponent
    {
        ...
        internal List<string> GetMacAddressesUsingWmi()
        {
            ...
            try
            {
                var managementObjectSearcher = new ManagementObjectSearcher("select MACAddress, PhysicalAdapter from Win32_NetworkAdapter");
        ...
        internal List<string> GetMacAddressesUsingCimV2()
        {
            ...
            var managementClass = new ManagementClass("root/StandardCimv2", "MSFT_NetAdapter", new ObjectGetOptions { });
